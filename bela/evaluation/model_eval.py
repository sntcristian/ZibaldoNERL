...
class ModelEval:
    ...
    def create_gpu_index(self, gpu_id=1):
    ...
    def process_disambiguation_batch(self, texts, mention_offsets, mention_lengths):
        batch: Dict[str, Any] = {
            "texts": texts,
        ...
        with torch.no_grad():
            ...
            for offsets, lengths in zip(
                ...
                for offset, length, entity, score in zip(ex_sp_offsets, ex_sp_lengths, ex_entities, ex_dis_scores):
                    predictions.append({
                        "start_pos": offset,
